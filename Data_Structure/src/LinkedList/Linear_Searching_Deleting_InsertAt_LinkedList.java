...
public class Linear_Searching_Deleting_InsertAt_LinkedList {
	    ...
	    void searchList(int key)
	    {
	      ...
	      else
	      {
	          ...
	          if(t==null)
	               ...
	               System.out.println(key+" found the list");
	    ...
	    public static void main(String args[])
	     {
	         ...
	         Linear_Searching_Deleting_InsertAt_LinkedList obj=new Linear_Searching_Deleting_InsertAt_LinkedList();
	         obj.createList();
	         int ch,e,pos;
	         do
	         {
